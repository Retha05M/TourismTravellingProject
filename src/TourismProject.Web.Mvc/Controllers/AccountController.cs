...
using TourismProject.Sessions;
using TourismProject.Web.Models.Account;
using TourismProject.Web.Views.Shared.Components.TenantChange;

namespace TourismProject.Web.Controllers
{
    public class AccountController : TourismProjectControllerBase
    {
