...
using TourismProject.Models.TokenAuth;
...
{
    public abstract class TourismProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TourismProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TourismProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TourismProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TourismProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TourismProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TourismProjectDbContext, Task<T>> func)
        {
            T result;
